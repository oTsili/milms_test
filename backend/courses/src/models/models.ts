...
import { UserDoc, UserModel, userSchema } from './user';
import { CourseDoc, CourseModel, courseSchema } from './course';
import { AssignmentModel, AssignmentDoc, assignmentSchema } from './assignment';
